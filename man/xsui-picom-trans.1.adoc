...
NAME
----
xsui-picom-trans - an opacity setter tool

SYNOPSIS
--------

*xsui-picom-trans* [-w _WINDOW_ID_] [-n _WINDOW_NAME_] [-c] [-s] _OPACITY_

DESCRIPTION
-----------

*xsui-picom-trans* is a bash script that sets __NET_WM_WINDOW_OPACITY_ attribute of a window using standard X11 command-line utilities, including *xprop*(1) and *xwininfo*(1). It is similar to *transset*(1) or *transset-df*(1).
...
+
------------
xsui-picom-trans -c --delete
------------

* Toggle current window's opacity between 90 and unset
+
------------
xsui-picom-trans -c --toggle 90
------------

* Reset all windows:
+
------------
xsui-picom-trans --reset
------------
...
SEE ALSO
--------
xref:xsui-picom.1.adoc[*xsui-picom*(1)], *xprop*(1), *xwininfo*(1)
